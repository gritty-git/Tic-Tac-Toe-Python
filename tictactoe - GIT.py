...
def win_check():
    ...
    if (board[1]==board[2]==board[0] or board[5]==board[4]==board[3] or board[6]==board[7]==board[8] or board[0]==board[3]==board[6] or board[1]==board[4]==board[7] or board[8]==board[2]==board[5] or board[8]==board[2]==board[5] or board[8]==board[4]==board[0] or board[6]==board[2]==board[4]): 
            ...
            if c=='y':
                ...
                print("You Lost against 6.74 kB of code")
    elif (ctr>=8):
        fl=1
        print("Match Drawn")    
def hum_move():
    ...
    while ty==1:
       ...
       if mv in done:
           ...
           print("Choice not available, re-enter choice")
       else:
            ty=1
            done.append(mv)
            board[int(mv)]='o'
...
def main():
    global ctr
    display_instruct()
    print("Want to take the 1st chance : y / n")
    global c
    c=input()
    if c=='y' or c=='Y':
        hum_move()
        ...
        print("Choice not understood, please restart the game")
    status()    
    while (fl==0):
            if c=='n':
                hum_move()
